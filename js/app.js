...
$(window).scroll(function () {
    $("#counter").each(function () {
        ...
        if (cPos < topWindow + 700) {
            $(".counter__num").addClass("active");
            $(".counter__move").addClass("active__move-1");
            $(".counter__move2").addClass("active__move-2");
            $(".counter__move3").addClass("active__move-3");
            $(".counter__move4").addClass("active__move-4");
...
let counterSectionTop = counterSection.offset().top;
$(window).bind('scroll', function () {
    let windowTop = $(this).scrollTop();
    if (windowTop > counterSectionTop) {
        // console.log('Докрутили');
        $('.creation__right').html(`<iframe class="iframe" src="https://www.youtube.com/embed/zKNoU2P0dQc" frameborder="0"
